                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-5">
                                    <div class="product-details-content">
                                        ...
                                        <form action="{{url('add-to carts-details/'.$product->id)}}" method="POST">
                                            @csrf
                                        ...
                                        <div class="product-details-select-items-wrap">
                                            @foreach ($product->size as $sizeName )
                                                <div class="product-details-select-item-outer">
                                                <input type="radio" name="size" value="{{$sizeName->size_name}}XXl" class="category-item-radio">
                                                <label for="size" class="category-item-label">
                                                    {{$sizeName->size_name}}
                                                </label>
                                            </div>
                                            @endforeach
                        ...
                        <div class="product-details-sidebar">
                            <div class="product-details-categoris">
                              ...
                              @foreach ($categories as $category )
                                    <a href="{{'/category-product'}}" class="category-item-outer">
